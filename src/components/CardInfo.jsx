...
export default function CardInfo({ location }) {
  return (
    <div className="cardInfo">
      ...
      <div className="carInfo__container">
        <div className="cardInfo__item">
          ...
          <p className="cardInfo__item-value">{location?.type}</p>
        </div>
        <div className="cardInfo__item">
          <h3 className="cardInfo__item-title">Dimension</h3>
          <p className="cardInfo__item-value">{location?.dimension}</p>
        </div>
        <div className="cardInfo__item">
          <h3 className="cardInfo__item-title">Population</h3>
          <p className="cardInfo__item-value">{location?.residents?.length}</p>
        </div>
      </div>
    </div>
  );
